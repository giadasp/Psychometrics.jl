...
for rep in replications
    ...
    # starting values
    map( i -> begin
        i.parameters.a = Float64(mean(a_operational))
    end, items_est_field);
    map( i -> begin
    ...
    while retired_items < I_field  
        ...
        for i in 1:test_operational
            ...
            Psychometrics.assess_examinee_pg!(examinee, items_est[items_idx_n], responses_n; mcmc_iter = iter_mcmc_latent, sampling = false, already_sorted = true)

...
function calibrate_item_mmle!(
    ...
    map( i -> calibrate_item_mmle!(i, examinees, responses; int_opt_x_tol_rel = int_opt_x_tol_rel, int_opt_max_time = int_opt_max_time, int_opt_f_tol_rel = int_opt_f_tol_rel), items)
    return nothing
end